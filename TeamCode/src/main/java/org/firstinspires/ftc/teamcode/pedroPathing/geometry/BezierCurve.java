// Change package to match file path
...
import org.firstinspires.ftc.teamcode.pedroPathing.math.MatrixUtil;
...
import org.firstinspires.ftc.teamcode.pedroPathing.geometry.CharacteristicMatrixSupplier;
import org.firstinspires.ftc.teamcode.pedroPathing.geometry.TVector;
    ...
    public BezierCurve(List<Pose> controlPoints, PathConstraints constraints){
        ...
        if (controlPoints.size()<3) {
            try {
                ...
                // TODO: Use robust logging here
                // e.printStackTrace();
            }
        }
        ArrayList<Pose> initializedControlPoints = new ArrayList<>(controlPoints);
