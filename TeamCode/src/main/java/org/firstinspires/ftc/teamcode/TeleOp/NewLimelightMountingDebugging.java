...
@TeleOp(name="New Limelight Mounting Debug", group="DEBUG")
public class NewLimelightMountingDebugging extends LinearOpMode {
    private Utilities000 bot;
